...
namespace TrainMuseum.DAC
{
    public class MuseumShowDAC
    {
        ...
        {
            string sql = " select m.museumTitle, m.spectation, m.museumContents, p.photofile1, p.photofile2, p.photofile3 from museum m inner join museumphoto p on m.museumno = p.museumno where museumTitle =@museumTitle;" ;
