...
namespace TrainMuseum.DAC
{
    class BoardShowDAC
    {
        ...
        {
            string sql = " select m.boardno, m.boardTitle, m.boardContents, p.photofile1, p.photofile2, p.photofile3, p.photofile4, p.photofile5 from board m inner join boardphoto p on m.boardno = p.boardno where boardTitle =@boardTitle; ";
